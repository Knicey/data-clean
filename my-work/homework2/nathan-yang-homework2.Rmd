...
e.  This is an okay approach to blocking because 91% of the true matches are correctly blocked together

f.  This is not a recommended approach to entity resolution because a very very minute percentage of the classified matches are true matches
